package cloud.thecode.library.radio;
...
import cloud.thecode.library.R;
...
public class RadioPlayerService extends Service implements PlayerCallback {
    ...
    private void buildNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            ...
            mExpandedView.setImageViewResource(R.id.notification_expanded_play, isPlaying() ? R.drawable.ic_pink_pause : R.drawable.ic_play);
